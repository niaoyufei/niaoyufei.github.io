      ...
      <main className="pt-24 pb-12 min-h-[90vh] flex flex-col items-center justify-center">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-start justify-center gap-12 md:gap-16 lg:gap-24">
            ...
            {/* Right: Features List */}
            <div className="w-full md:w-7/12 lg:w-1/2 order-2 flex flex-col space-y-8 pt-4 md:pt-10">
              <div className="text-center md:text-left space-y-4">
                <span className="inline-block px-3 py-1 rounded-full bg-green-900/30 text-green-300 text-xs font-bold tracking-wide uppercase border border-green-900/50">
                  WeChat Mini Program
                </span>
