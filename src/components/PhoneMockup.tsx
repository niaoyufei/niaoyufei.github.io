...
interface PhoneMockupProps {
  mediaUrl?: string; // Optional if using customContent
  mediaType?: 'image' | 'video' | 'component';
  customContent?: React.ReactNode;
}

const PhoneMockup: React.FC<PhoneMockupProps> = ({ mediaUrl, mediaType, customContent }) => {
  return (
    <div className="relative mx-auto border-zinc-800 bg-zinc-950 border-[14px] rounded-[2.5rem] h-[600px] w-[300px] shadow-xl overflow-hidden">
      {/* 手机听筒/刘海区域 */}
